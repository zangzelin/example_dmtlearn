...
dmt = DMT(num_fea_aim=0.99, device_id=0, epochs=5000, batch_size=2000, K=5, nu=1e-2)
dmt.fit(DATA)
...
ax_1.scatter(X_cel_dmt[:, 0], X_cel_dmt[:, 1], c=y_cel_em, cmap='tab10', s=2)
...
ax_2.scatter(X_cel_umap[:, 0], X_cel_umap[:, 1], c=y_cel_em, cmap='tab10', s=2)
...
ax_3.scatter(X_cel_tsne[:, 0], X_cel_tsne[:, 1], c=y_cel_em, cmap='tab10', s=2)
